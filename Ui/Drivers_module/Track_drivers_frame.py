...
def Track_drivers_frame(master):
    ...
    drivers_list_frame = LabelFrame(master, text='المناديب')
    drivers_list_frame.pack(fill='both', side='right')
    
    
    driver_treeview_scroller = Scrollbar(drivers_list_frame, orient='vertical', cursor='hand2')
    driver_treeview_scroller.pack(fill='both', side='right')

    # شجرة عرض البيانات
    driver_treeview = Treeview(drivers_list_frame, cursor='hand2',
                            columns=(0,1,2), show='headings', bootstyle='info', yscrollcommand=driver_treeview_scroller.set)
    driver_treeview.pack(fill='both', side='left', expand=True)
    driver_treeview_scroller.config(command=driver_treeview.yview)
...
#############################################################################################################################################
    ...
    tasks_treeview_scroller = Scrollbar(drivers_list_panding_consignments, orient='vertical', cursor='hand2')
    tasks_treeview_scroller.pack(fill='both', side='right')

    # شجرة عرض البيانات
    tasks_treeview = Treeview(drivers_list_panding_consignments, cursor='hand2',
                            columns=(0,1,2,3,4), show='headings', bootstyle='info', yscrollcommand=tasks_treeview_scroller.set)
    tasks_treeview.pack(fill='both', side='left', expand=True)
    tasks_treeview_scroller.config(command=driver_treeview.yview)
    tasks_treeview.heading(4, text='م.#')
    tasks_treeview.heading(3, text='رقم الراتب')
    tasks_treeview.heading(2, text='جاري التوصيل')
    tasks_treeview.heading(1, text='تم التوصيل')
    tasks_treeview.heading(0, text='إستلام شحنات')
